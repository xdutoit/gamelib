...
historique:
0.1 - 05.05.2020 1ère version partiellement fonctionnelle (mise à l'échelle pas encore implementée)
...
window.onload = function(){
	...
	if(cnv){
		GL.cnv_dim = [cnv.width, cnv.height];
		if(cnv.getContext){
			GL.ctx = cnv.getContext('2d');
		}
		else{
